...
<p> <img src="https://skillicons.dev/icons?i=js,ts,react,nextjs,nodejs,express,postgres,mongodb,docker,kubernetes,aws,git,github,linux,bash,terraform,figma,remix,nginx,grafana,prometheus,jest,cypress,vite,nestjs,graphql,apollo,redis,postman" /> </p>
📈 GitHub Stats
